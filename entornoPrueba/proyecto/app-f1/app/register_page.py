...
class RegisterPage(BasePage):
    def __init__(self, master):
        ...
        self.age_entry = ctk.CTkEntry(self.content, placeholder_text="Edad", validate="key", validatecommand=vcmd, width=80)
        ...
        # Botones
        self.register_btn = ctk.CTkButton(self.content, text="Registrar", command=self.register, width=180)
        self.register_btn.pack(pady=(10, 5))
        self.back_btn = ctk.CTkButton(self.content, text="Volver", command=self.go_back, width=180)
