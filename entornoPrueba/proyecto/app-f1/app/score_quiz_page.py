...
class ScoreQuizPage(ctk.CTkFrame):
    ...
    def show_history(self):
        ...
        ctk.CTkLabel(self, text="Resumen de Quizzes").pack(pady=10)
        if historial:
        ...
        ctk.CTkButton(self, text="Historial Quiz", command=self.open_historyQuiz).pack(pady=10)
        ctk.CTkButton(
            self,
